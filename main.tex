...
%----------- RELEVANT COURSEWORK -----------
    ...
    \simpleParagraph{
        \begin{itemize}
            ...
            \item Implemented a five-stage microprocessor based of the DLX ISA in VHDL and flashed it to a Altera FPGA.
                The processor communicated with a desktop computer via UART and was tested with several different programs 
                written in DLX assembly. Each VHDL module was extensively tested using Modelsim or GHDL.
